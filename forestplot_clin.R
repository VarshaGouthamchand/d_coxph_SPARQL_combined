...
HR1 <- c(0.42,2.54,0.83,0.50,3.37)
HR2 <- c(0.40,2.52,1.31,0.83,2.29)
lower1 <- c(0.34,2.05,0.66,0.40,2.74)
lower2 <- c(0.32,2.02,1.04,0.63,1.74)
upper1 <- c(0.51,3.15,1.04,0.62,4.16)
upper2 <- c(0.49,3.14,1.66,1.09,3.01)
p.value1 <- c(0.0001,0.0001,0.1,0.0001,0.0001)
p.value2 <- c(0.0001,0.0001,0.1,0.23,0.0001)
